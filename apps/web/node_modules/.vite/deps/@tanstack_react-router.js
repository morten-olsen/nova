...
import {
  require_react_dom
} from "./chunk-UKHE55BN.js";
import {
  require_jsx_runtime
} from "./chunk-B3FN4KYR.js";
import {
  require_react
} from "./chunk-E365BB42.js";
import {
  __commonJS,
  __toESM
...
var require_use_sync_external_store_shim_development = __commonJS({
  "../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.8/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React3 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState5 = React3.useState, useEffect6 = React3.useEffect, useLayoutEffect3 = React3.useLayoutEffect, useDebugValue = React3.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@19.2.8/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React3 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef6 = React3.useRef, useEffect6 = React3.useEffect, useMemo3 = React3.useMemo, useDebugValue = React3.useDebugValue;
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/utils.js
var React$1 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/not-found.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/root.js
var rootRouteId = "__root__";

// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/redirect.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/utils.js
function last(arr) {
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/lru-cache.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/invariant.js
function invariant() {
  throw new Error("Invariant failed");
}

// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/new-process-route-tree.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/path.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/scroll-restoration.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/qss.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/searchParams.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/rewrite.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/stores.js
...
// ../../node_modules/.pnpm/@tanstack+history@1.162.0/node_modules/@tanstack/history/dist/esm/index.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/router.js
  ...
  */
  constructor(options, getStoreConfig) {
    ...
    this.getMatchedRoutes = (pathname) => {
      ...
      const match = findRouteMatch(trimPathRight2(pathname), this.processedTree, true);
    ...
    this.commitLocation = async ({ viewTransition, ignoreBlocker, ...next }) => {
      let historyAction;
      const isSameLocation = trimPathRight2(this.latestLocation.href) === trimPathRight2(next.href) && deepEqual(_getUserHistoryState(next.state), _getUserHistoryState(this.latestLocation.state));
  ...
  matchRoutesInternal(next, opts) {
    ...
    for (let index = 0; index < matchedRoutes.length; index++) {
      ...
      const existingMatch = opts?._rematerialize ? void 0 : this._cache.get(matchId) ?? (previousMatch?.id === matchId ? previousMatch : void 0);
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/load-client.js
function replaceRouteChunk(route, lazyFn2) {
  route.lazyFn = lazyFn2 ?? route.lazyFn;
  route._lazy = void 0;
}
...
function loadRouteChunk(route, componentType, onPendingReady) {
  ...
  const promise = route.lazyFn().then((lazyRoute) => {
    ...
    if (route._lazy === promise) route._lazy = void 0;
    throw error;
  });
  route._lazy = promise;
...
function normalize2(value, rejected, routeId) {
...
function normalizeError(route, cause) {
  let outcome = normalize2(cause, true, route.id);
  if (outcome[0] !== ERROR) return outcome;
  try {
    route.options.onError?.(outcome[1]);
  } catch (onErrorCause) {
    outcome = normalize2(onErrorCause, true, route.id);
  }
  return outcome;
}
...
async function contextualize(router, lane, options, end, planSuccessfulLane) {
  ...
  for (let index = options[7] ?? 0; index < end; index++) {
    ...
    try {
      ...
      const outcome = normalize2(result, false, route.id);
...
function releaseOwnedFlight(router, match, flight) {
  ...
  if (router._flights?.get(match.id) === flight) {
    ...
    if (current && !current[0].signal.aborted && !current[6] && !current[3].includes(match) && current[3].some((candidate) => candidate.id === match.id) && current[3].some((candidate) => candidate.isFetching === "beforeLoad")) return;
...
function transferPredecessorResources(router, previous, next) {
  ...
  for (const match of previous) if (!next.includes(match)) {
    const flight = match._flight;
    match._flight = void 0;
    if (flight?.[2] === 1 && router._flights?.get(match.id) === flight && !router._tx?.[6] && next.some((candidate) => candidate.id === match.id)) flight[2] = 0;
    else {
      const controller = releaseOwnedFlight(router, match, flight);
      if (controller) abort.push(controller);
    }
...
async function loadResource(router, lane, match, route, loader, parentMatchPromise, preload, owner) {
  ...
  try {
    if (!flight) {
      ...
      flight = [
        Promise.resolve().then(() => loader(getLoaderContext(router, lane, match, route, controller, parentMatchPromise, preload))).then((value) => normalize2(value, false, route.id), (cause) => normalize2(cause, true, route.id)).then((result) => {
...
function createLoaderTask(router, lane, index, tasks, semanticParent, options) {
  ...
  let donor = (!preload || route.options.preload !== false) && routeLoader && !router._tx?.[6] ? router._flights?.get(match.id) : void 0;
...
async function followRedirect(router, tx, redirect2) {
...
async function runClientTransaction(router, tx, forceStaleReload, onReady, sync, resolvedPrefix) {
  ...
  if (isControl(result)) {
    if (result[0] === REDIRECTED && router._tx === tx) {
      ...
      tx[3] = [];
      if (router._tx === tx) {
        if (tx[6]) router._refreshNextLoad = true;
  ...
  await router.startViewTransition(async () => {
    ...
    const rendered = tx[6] ? await transitionRefresh(router, tx, result, changeInfo) : await router.startTransition(commit, result[1]);
    if (tx[6] && rendered === void 0) return;
    if (router._tx !== tx) {
...
async function loadClientRoute(router, opts) {
  ...
  try {
    matches = rematerialize ? router.matchRoutes(location, {
    ...
    preflight.abort();
    if (!isRedirect(cause)) {
      if (rematerialize) router._refreshNextLoad = void 0;
...
async function preloadClientRoute(router, opts, redirects = 0) {
  ...
  if (router._refreshNextLoad || router._tx?.[6]) return;
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/await-signal.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/load-server.js
var SUCCESS2 = 0;
var ERROR2 = 1;
var NOT_FOUND2 = 2;
var REDIRECTED2 = 3;
var SKIPPED = 4;
function getRoute2(router, match) {
  return router.routesById[match.routeId];
}
function normalize3(value, rejected) {
  if (isRedirect(value)) return [REDIRECTED2, value];
  if (isNotFound(value)) return [NOT_FOUND2, value];
  if (rejected && typeof value?.then === "function") value = new Error("A Promise was thrown", { cause: value });
  return rejected ? [ERROR2, value] : [SUCCESS2, value];
}
function normalizeError2(route, cause) {
  let outcome = normalize3(cause, true);
  if (outcome[0] !== ERROR2) return outcome;
  try {
    route.options.onError?.(outcome[1]);
  } catch (onErrorCause) {
    outcome = normalize3(onErrorCause, true);
  }
  return outcome;
}
...
function stampNotFound(match, outcome) {
  if (outcome[0] === NOT_FOUND2 && !outcome[1].routeId) outcome[1].routeId = match.routeId;
  return outcome;
}
async function contextualize2(router, lane, signal) {
  ...
  for (let index = 0; index < end; index++) {
    ...
    try {
      ...
      failure = [index, stampNotFound(match, normalizeError2(route, cause))];
      end = index;
    }
    signal?.throwIfAborted();
    if (failure?.[1][0] === REDIRECTED2) break;
    ...
    try {
      ...
      if (route.options.context) {
        const routeContextOptions = {
          ...
          context: parentContext,
          location: lane.location,
          navigate: navigateFrom2(router, lane.location),
          buildLocation: router.buildLocation,
          cause: match.cause,
      ...
      signal?.throwIfAborted();
      if (!failure) failure = [index, stampNotFound(match, normalizeError2(route, cause))];
      end = index;
      break;
    }
    signal?.throwIfAborted();
    ...
    const validationError = match.paramsError ?? match.searchError;
    if (validationError !== void 0) {
      failure = [index, stampNotFound(match, normalizeError2(route, validationError))];
      end = index;
      break;
    }
    signal?.throwIfAborted();
    ...
    try {
      ...
      signal?.throwIfAborted();
      const outcome = stampNotFound(match, normalize3(beforeLoadContext, false));
      if (outcome[0] !== SUCCESS2) {
...
function getLoaderContext2(router, lane, match, route, index, tasks) {
  return {
    params: match.params,
    deps: match.loaderDeps,
    preload: false,
...
function createLoaderTask2(router, lane, index, tasks, signal) {
  const match = lane.matches[index];
  const route = getRoute2(router, match);
  let outcome;
  if (match.ssr === false) outcome = Promise.resolve([SKIPPED]);
    ...
    const routeLoader = route.options.loader;
    const loader = typeof routeLoader === "function" ? routeLoader : routeLoader?.handler;
    if (!loader) outcome = Promise.resolve([SUCCESS2, void 0]);
    else outcome = Promise.resolve().then(() => loader(getLoaderContext2(router, lane, match, route, index, tasks))).then((result) => normalize3(result, false), (cause) => normalize3(cause, true)).then((result) => {
      if (result[0] !== REDIRECTED2 && (signal?.aborted || match.abortController.signal.reason === lane)) return [SKIPPED];
      if (result[0] === ERROR2) result = normalizeError2(route, result[1]);
      return stampNotFound(match, result);
    });
  }
  const parentMatch = outcome.then((result) => {
    const snapshot = { ...match };
    if (result[0] === SUCCESS2) {
...
async function getNotFoundBoundary2(router, matches, indexed, signal, fallback = 0) {
  const cause = indexed?.[1][1];
  let index = cause?.routeId ? matches.findIndex((match) => match.routeId === cause.routeId) : indexed?.[0] ?? matches.length - 1;
  if (index < 0) index = 0;
  for (let candidate = index; candidate >= 0; candidate--) {
    const route = getRoute2(router, matches[candidate]);
    const loading = loadRouteChunk(route, false);
    if (loading) try {
      await loading;
    } catch {
...
async function applyFailure(router, lane, indexed, signal) {
  ...
  const boundary = indexed[2] ?? await getNotFoundBoundary2(router, lane.matches, indexed, signal);
    ...
    try {
      ...
      if (loading) {
        const chunk = loading.then(() => {
          ...
          signal?.throwIfAborted();
          return [index, stampNotFound(match, normalizeError2(route, cause))];
        });
        chunk.catch(() => {
        });
        chunks.push(chunk);
      ...
      signal?.throwIfAborted();
      chunks.push([index, stampNotFound(match, normalizeError2(route, cause))]);
    }
  }
...
async function projectLane2(router, lane, signal) {
  for (const match of lane.matches) {
    const routeOptions = getRoute2(router, match).options;
...
async function executeServerLane(router, location, matchedMatches, signal) {
  ...
  try {
    ...
    if (router.options.notFoundMode !== "root" && plannedGlobalBoundary >= 0) {
      const boundary = await getNotFoundBoundary2(router, matched.matches, void 0, signal, plannedGlobalBoundary);
    ...
    const lane = await contextualize2(router, matched, signal);
    signal?.throwIfAborted();
    let loaderEnd = lane.end;
    if (lane.failure?.[1][0] === REDIRECTED2) loaderEnd = 0;
    else if (lane.failure?.[1][0] === NOT_FOUND2) {
      lane.failure[2] = await getNotFoundBoundary2(router, lane.matches, lane.failure, signal);
      loaderEnd = Math.min(loaderEnd, lane.failure[2] + 1);
    }
    const tasks = [];
    for (let index = 0; index < loaderEnd; index++) {
      const task = createLoaderTask2(router, lane, index, tasks, signal);
      tasks.push(task);
    }
    let loaderFailure;
    let control = lane.failure?.[1][0] === REDIRECTED2 ? lane.failure : void 0;
    try {
    ...
    let readinessEnd;
    if (failure) {
      const outcomeEnd = failure[2] ??= failure[1][0] === NOT_FOUND2 ? await getNotFoundBoundary2(router, lane.matches, failure, signal) : failure[0];
      for (const task of tasks) {
        if (task.index >= outcomeEnd) break;
        const outcome = await task.outcome;
        if (outcome[0] !== SUCCESS2 && outcome[0] < REDIRECTED2 && !("loaderData" in lane.matches[task.index])) {
          failure = [task.index, outcome];
          failure[2] = outcome[0] === NOT_FOUND2 ? await getNotFoundBoundary2(router, lane.matches, failure, signal) : task.index;
          break;
        }
      }
    ...
    signal?.throwIfAborted();
    if (requiredFailure) {
      if (requiredFailure[1][0] === REDIRECTED2) {
    ...
    if (terminal.boundary !== void 0) {
      ...
      if (match.ssr === true) {
        const route = getRoute2(router, match);
        try {
          if (terminal.kind === ERROR2) await loadRouteChunk(route, "errorComponent");
...
async function loadServerRoute(router, opts) {
  ...
  try {
    ...
    result = await waitFor2(executeServerLane(router, next, router.matchRoutes(next), opts?._signal), opts?._signal);
    opts?._signal?.throwIfAborted();
  } catch (cause) {
    opts?._signal?.throwIfAborted();
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/isServer/development.js
var isServer = void 0;
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/defer.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/link.js
var preloadWarning = "Error preloading route! ☝️";

// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/manifest.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/Matches.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/route.js
var BaseRoute = class {
  get to() {
    return this._to;
  }
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/config.js
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/searchMiddleware.js
function retainSearchParams(keys) {
  return ({ search, next }) => {
    ...
    if (keys === true) {
      ...
      const explicit2 = meta.explicit;
      for (const key of removed?.keys() || []) if (explicit2 && hasOwn.call(explicit2, key) || deepEqual(search[key], removed.get(key))) delete copy2[key];
      for (const key of meta.removedAny || []) delete copy2[key];
      for (const key of meta.defaulted?.keys() || []) if (key in search && !meta.removedAny?.has(key) && !(meta.removed?.has(key) && (explicit2 && hasOwn.call(explicit2, key) || deepEqual(search[key], meta.removed.get(key))))) copy2[key] = search[key];
      return copy2;
    }
...
// ../../node_modules/.pnpm/seroval@1.6.2/node_modules/seroval/dist/dev/index.js
...
var TRUE_NODE = createConstantNode(2);
var FALSE_NODE = createConstantNode(3);
var UNDEFINED_NODE = createConstantNode(1);
var NULL_NODE = createConstantNode(0);
var NEG_ZERO_NODE = createConstantNode(4);
var INFINITY_NODE = createConstantNode(5);
var NEG_INFINITY_NODE = createConstantNode(6);
var NAN_NODE = createConstantNode(7);
...
var SerovalMode = (function(SerovalMode2) {
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/ssr/serializer/transformer.js
function createSerializationAdapter(opts) {
  return opts;
}

// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/ssr/serializer/RawStream.js
var RawStream = class {
...
// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/ssr/serializer/ShallowErrorPlugin.js
...
// ../../node_modules/.pnpm/seroval-plugins@1.6.2_seroval@1.6.2/node_modules/seroval-plugins/dist/dev/rolldown-runtime-D7D4PA-g.js
...
// ../../node_modules/.pnpm/seroval-plugins@1.6.2_seroval@1.6.2/node_modules/seroval-plugins/dist/dev/web-43VA2W_p.js
...
var FormDataPlugin = createPlugin({
  ...
  extends: [FilePlugin, createPlugin({
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/awaited.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/CatchBoundary.js
var React$13 = __toESM(require_react(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
function CatchBoundary(props) {
  return (0, import_jsx_runtime2.jsx)(CatchBoundaryImpl, { ...props });
}
var CatchBoundaryImpl = class extends React$13.Component {
  ...
  render() {
    ...
    return error ? React$13.createElement(this.props.errorComponent ?? ErrorComponent, {
      error,
      reset: this.reset
    }) : this.props.children;
  }
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/ClientOnly.js
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
function ClientOnly({ children, fallback = null }) {
  return (0, import_jsx_runtime3.jsx)(import_react.default.Fragment, { children: useHydrated() ? children : fallback });
}
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/routerContext.js
var React$14 = __toESM(require_react(), 1);
var routerContext = React$14.createContext(null);

// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useRouter.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/matchContext.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useMatch.js
var React$17 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+store@0.9.3/node_modules/@tanstack/store/dist/esm/alien.js
...
// ../../node_modules/.pnpm/@tanstack+store@0.9.3/node_modules/@tanstack/store/dist/esm/atom.js
...
// ../../node_modules/.pnpm/@tanstack+react-store@0.9.3_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-store/dist/esm/useStore.js
...
function useMatch(opts) {
  ...
  const nearestRouteId = React$17.useContext(opts.from ? dummyMatchContext : matchContext);
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useLoaderData.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useLoaderDeps.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useParams.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useSearch.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useNavigate.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useRouteContext.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/link.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/route.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/fileRoute.js
...
function FileRouteLoader(_path) {
  if (true) console.warn(`Warning: FileRouteLoader is deprecated and will be removed in the next major version. Please place the loader function in the main route file, inside the \`createFileRoute('/path/to/file')(options)\` options`);
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/lazyRouteComponent.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/not-found.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/ScriptOnce.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/SafeFragment.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/renderRouteNotFound.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/scroll-restoration.js
var import_jsx_runtime10 = __toESM(require_jsx_runtime(), 1);

// ../../node_modules/.pnpm/@tanstack+router-core@1.171.17/node_modules/@tanstack/router-core/dist/esm/scroll-restoration-script/client.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Match.js
var React$111 = __toESM(require_react(), 1);
var import_jsx_runtime11 = __toESM(require_jsx_runtime(), 1);
function renderPending(router, route) {
  const PendingComponent = route?.options.pendingComponent ?? router.options.defaultPendingComponent;
  return PendingComponent ? (0, import_jsx_runtime11.jsx)(PendingComponent, {}) : null;
}
var outletMatchSelectionEqual = (a, b) => a[0] === b[0] && a[1] === b[1];
var Match = React$111.memo(function MatchImpl({ routeId }) {
  const router = useRouter();
  if (isServer ?? router.isServer) return (0, import_jsx_runtime11.jsx)(MatchView, {
    router,
...
function MatchView({ router, match }) {
  ...
  const ResolvedSuspenseBoundary = route.options.wrapInSuspense ?? pendingElement ?? (route.options.errorComponent?.preload || resolvedNoSsr) ? React$111.Suspense : SafeFragment;
    ...
    children: (0, import_jsx_runtime11.jsx)(ResolvedSuspenseBoundary, {
      ...
      children: (0, import_jsx_runtime11.jsx)(ResolvedCatchBoundary, {
        ...
        onCatch: (error, errorInfo) => {
          ...
          if (true) console.warn(`Warning: Error in route match: ${match.id}`);
        ...
        children: (0, import_jsx_runtime11.jsx)(ResolvedNotFoundBoundary, {
          ...
          children: resolvedNoSsr ? (0, import_jsx_runtime11.jsx)(ClientOnly, {
            fallback: pendingElement,
            children: (0, import_jsx_runtime11.jsx)(MatchInner, { match })
          }) : (0, import_jsx_runtime11.jsx)(MatchInner, { match })
        })
      })
    })
  }), (isServer ?? router.isServer) && route.parentRoute?.id === rootRouteId && router.options.scrollRestoration ? (0, import_jsx_runtime11.jsx)(ScrollRestoration, {}) : null] });
}
var MatchInner = React$111.memo(function MatchInnerImpl({ match }) {
  const router = useRouter();
  ...
  const out = React$111.useMemo(() => {
    ...
    return Comp ? (0, import_jsx_runtime11.jsx)(Comp, {}, key) : (0, import_jsx_runtime11.jsx)(Outlet, {});
  }, [
    key,
...
var Outlet = React$111.memo(function OutletImpl() {
  const router = useRouter();
  const routeId = React$111.useContext(matchContext);
  ...
  const nextMatch = (0, import_jsx_runtime11.jsx)(Match, { routeId: childRouteId });
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Transitioner.js
...
function Transitioner() {
  ...
  const mounted = true ? React$112.useRef(false) : void 0;
  ...
  if (true) router._cancelTransition = () => settleOwner(acknowledgement, false);
  useLayoutEffect2(() => {
    ...
    if (trimPathRight2(location.publicHref) !== trimPathRight2(nextLocation.publicHref)) {
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Matches.js
...
function Matches() {
  ...
  const ResolvedSuspense = (isServer ?? router.isServer) || router.ssr ? SafeFragment : React$113.Suspense;
  const inner = (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [!(isServer ?? router.isServer) && (0, import_jsx_runtime12.jsx)(Transitioner, {}), (0, import_jsx_runtime12.jsx)(ResolvedSuspense, {
    fallback: pendingElement,
    children: (0, import_jsx_runtime12.jsx)(MatchesInner, {})
  })] });
...
function MatchesInner() {
  ...
  const matchComponent = routeId ? (0, import_jsx_runtime12.jsx)(Match, { routeId }) : null;
...
function useParentMatches(opts) {
  const contextRouteId = React$113.useContext(matchContext);
  return useMatches({
    select: (matches) => {
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/routerStores.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/router.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/RouterProvider.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/ScrollRestoration.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useBlocker.js
...
function useBlocker(opts, condition) {
  ...
  React$114.useEffect(() => {
    ...
    return disabled ? void 0 : history2.block({
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useRouterState.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useLocation.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/useCanGoBack.js
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Asset.js
...
function Asset(asset) {
  ...
  switch (asset.tag) {
    ...
    case "style":
      if (asset.inlineCss && (process.env.TSS_INLINE_CSS_ENABLED === "true" || process.env.TSS_INLINE_CSS_ENABLED === void 0 && isServer)) return (0, import_jsx_runtime14.jsx)(InlineCssStyle, {
        attrs,
        nonce,
        children
      });
...
function InlineCssStyle({ attrs, children, nonce }) {
  ...
  const [hydratedInlineCss] = React$115.useState(() => {
...
function Script({ attrs, children, preventScriptHoist }) {
  ...
  if (isServer ?? router.isServer) {
    if (attrs?.src) {
      if (!preventScriptHoist) return (0, import_jsx_runtime14.jsx)("script", {
        ...attrs,
        suppressHydrationWarning: true
      });
      return (0, import_jsx_runtime14.jsx)("script", {
  ...
  if (!hydrated) {
    if (attrs?.src) return (0, import_jsx_runtime14.jsx)("script", {
      ...attrs,
      suppressHydrationWarning: true
    });
    if (typeof children === "string") return (0, import_jsx_runtime14.jsx)("script", {
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/headContentUtils.js
...
var useTags = (assetCrossOrigin) => {
  ...
  const selectTags = React$116.useCallback((matches) => buildTagsFromMatches(router, nonce, matches, assetCrossOrigin), [
    assetCrossOrigin,
    nonce,
    router
  ]);
...
// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/Scripts.js
...
function renderScripts(router, scripts) {
  ...
  return (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, { children: scripts.map((asset, i) => (0, import_react8.createElement)(Asset, {
    ...asset,
    key: `tsr-scripts-${asset.tag}-${i}`
  })) });
}

// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/HeadContent.js
var import_react9 = __toESM(require_react(), 1);
var import_jsx_runtime16 = __toESM(require_jsx_runtime(), 1);

// ../../node_modules/.pnpm/@tanstack+react-router@1.170.20_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/@tanstack/react-router/dist/esm/HeadContent.dev.js
...
function HeadContent2(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: (hydrated ? tags.filter((tag) => tag.tag !== "link" || tag.attrs?.[DEV_STYLES_ATTR] !== true) : tags).map((tag) => (0, import_react10.createElement)(Asset, {
    ...tag,
