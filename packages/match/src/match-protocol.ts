import { gameRecordingSchema } from '@morten-olsen/nova-game';
import { z } from 'zod';
...
const resultMessageSchema = z.object({
  ...
  game: gameRecordingSchema.optional(),
...
const createInviteCode = (): string => {
  // Web Crypto rather than `node:crypto`, because the same code generates and
  // validates invite codes in the browser.
